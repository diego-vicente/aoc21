...
test "day 21 using test input":
  let input = day21.read_input("./assets/test/input_21.txt")
  check day21.solve_first_part(input) == 739785
  check day21.solve_second_part(input) == 444356092776315

test "day 22 using test input":
  var input = day22.read_input("./assets/test/input_22_1.txt")
  check day22.solve_first_part(input) == 39

  input = day22.read_input("./assets/test/input_22_2.txt")
  check day22.solve_first_part(input) == 590784

  input = day22.read_input("./assets/test/input_22_3.txt")
  check day22.solve_first_part(input) == 474140
  check day22.solve_second_part(input) == 2758514936282235
